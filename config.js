...
cfBucketDomain: process.env.CF_BUCKET_DOMAIN || "files.giftedtech.co.ke", // Your Cloudflare R2 Public Access Domain/Your Custom Binded Domain
...
imageMimetypes: process.env.IMAGE_MIMETYPES || "['image/jpeg', 'image/jpg', 'image/png', 'image/gif', 'image/webp', 'image/svg+xml', 'image/svg', 'application/svg+xml', 'image/avif', 'image/heif', 'image/heic', 'image/x-icon', 'image/vnd.microsoft.icon', 'image/ico', 'image/icon', 'image/x-ico', 'image/tiff']",
